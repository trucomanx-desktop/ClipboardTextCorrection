...
Download the binary file from the [release](https://github.com/trucomanx-desktop/ClipboardTextCorrection/releases) directory, then double-click to run it.
...
![open-config-file](https://raw.githubusercontent.com/trucomanx-desktop/ClipboardTextCorrection/main/images/open-config-file.win.png)
